      ...
      <div className="p-6 space-y-6">
        ...
        <section>
          ...
          <div className="flex items-center">
            ...
            <button className="btn-sm bg-black hover:bg-black text-white">Change</button>
          </div>
        </section>
        {/* Business Profile */}
        <section>
        ...
        <section>
          ...
          <div className="flex flex-wrap mt-5">
            ...
            <button className="btn border-gray-200 hover:border-gray-300 shadow-sm text-black">Change</button>
          </div>
        </section>
        {/* Password */}
        <section>
          ...
          <div className="mt-5">
            <button className="btn border-gray-200 shadow-sm text-black">Set New Password</button>
          </div>
        </section>
        {/* Smart Sync */}
        <section>
