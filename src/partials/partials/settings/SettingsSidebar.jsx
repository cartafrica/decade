        ...
        <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink
              ...
              className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                pathname.includes("/settings/account") && "bg-black"
              }`}
            >
              <svg
                className={`w-4 h-4 shrink-0 fill-current text-gray-400 mr-2 ${
                  pathname.includes("/settings/account") && "text-white"
                }`}
                viewBox="0 0 16 16"
              >
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink
              ...
              to="/settings/payout"
              className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                pathname.includes("/settings/payout") && "bg-black"
              }`}
            >
              <svg
                className={`w-4 h-4 shrink-0 fill-current text-gray-400 mr-2 ${
                  pathname.includes("/settings/payout") && "text-white"
                }`}
                viewBox="0 0 16 16"
              >
              ...
              <span
                className={`text-sm font-medium ${
                  pathname.includes("/settings/payout")
                    ? "text-white"
                    : "hover:text-gray-700"
                }`}
              >
          ...
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink
              ...
              to="/settings/verify"
              className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                pathname.includes("/settings/verify") && "bg-black"
              }`}
            >
              <svg
                className={`w-4 h-4 shrink-0 fill-current text-gray-400 mr-2 ${
                  pathname.includes("/settings/verify") &&
                  "text-white"
                }`}
                viewBox="0 0 16 16"
              >
        ...
        <ul className="flex flex-nowrap md:block mr-3 md:mr-0">
          <li className="mr-0.5 md:mr-0 md:mb-0.5">
            <NavLink
              ...
              className={`flex items-center px-2.5 py-2 rounded whitespace-nowrap ${
                pathname.includes("/settings/feedback") && "bg-black"
              }`}
            >
              <svg
                className={`w-4 h-4 shrink-0 fill-current text-gray-400 mr-2 ${
                  pathname.includes("/settings/feedback") && "text-white"
                }`}
                viewBox="0 0 16 16"
              >
