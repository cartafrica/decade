...
function InboxBody({
  ...
  const mails = [
    ...
    },
    {
      ...
      message: `<p>Hey Acme 👋</p><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis <span className="underline">nostrud exercitation ullamco</span> laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p><p>Consectetur adipiscing elit, sed do eiusmod <a className="font-medium text-black hover:text-black" href="#0">tempor magna</a> aliqua? Check below:</p><p><img src=${mailImage} width="320" height="190" alt="Inbox image" /></p><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p><p>Cheers,</p><p className="font-medium">Dominik Lamakani</p>`,
    },
  ];
      ...
      <div className="sticky bottom-0">
        <div className="flex items-center justify-between bg-white border-t border-gray-200 px-4 sm:px-6 md:px-5 h-16">
          ...
          <form className="grow flex">
            ...
            <button type="submit" className="btn bg-black hover:bg-black text-white whitespace-nowrap">Send -&gt;</button>
          </form>
        </div>
      </div>
