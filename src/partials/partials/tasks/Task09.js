  ...
  return (
    <div className="bg-white shadow-lg rounded-sm border border-gray-200 p-4">
      ...
      <div className="mb-3">
        ...
        {/* Content */}
        <div>
          <div className="text-sm">Dedicated form for a category of users that will perform actions? <a className="font-medium text-black hover:text-black" href="#0">#viewall</a></div>
        </div>
      </div>
      {/* Footer */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center">
          {/* Like button */}
          <button className="flex items-center text-gray-400 hover:text-black ml-3">
