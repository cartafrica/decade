...
import ShippingCard from "../partials/shipping/ShippingCard";
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      ...
      <div className="border-t border-gray-200">
        <div className="max-w-2xl m-auto mt-16 mb-16">
          <div className="text-center px-4">
            ...
            <div className="mb-6">
              Add places you deliver to and configure the rates to deliver
              there.
            </div>
            <button className="btn bg-black hover:bg-black text-white">
              <svg
