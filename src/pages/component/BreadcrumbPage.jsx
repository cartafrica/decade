                    ...
                    <div className="text-center">
                      ...
                      <ul className="inline-flex flex-wrap text-sm font-medium">
                        <li className="after:content-['/'] last:after:hidden after:text-gray-400 after:px-2">
                          <a className="text-gray-500 hover:text-black" href="#0">Home</a>
                        </li>
                        <li className="after:content-['/'] last:after:hidden after:text-gray-400 after:px-2">
                          <a className="text-gray-500 hover:text-black" href="#0">Settings</a>
                        </li>
                        <li className="after:content-['/'] last:after:hidden after:text-gray-400 after:px-2">
                          <a className="text-gray-500 hover:text-black" href="#0">Notifications</a>
                        </li>
                      </ul>
                      {/* End */}
                    </div>
