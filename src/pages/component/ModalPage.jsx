              ...
              <div className="space-y-8 mt-8">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="basic-modal" onClick={(e) => { e.stopPropagation(); setBasicModalOpen(true); }}>Basic Modal</button>
                      <ModalBasic id="basic-modal" modalOpen={basicModalOpen} setModalOpen={setBasicModalOpen} title="Basic Modal">
                        ...
                        <div className="px-5 py-4">
                          <div className="flex flex-wrap justify-end space-x-2">
                            ...
                            <button className="btn-sm bg-black hover:bg-black text-white">I Understand</button>
                          </div>
                        </div>
                      </ModalBasic>
                      {/* End */}
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="scrollbar-modal" onClick={(e) => { e.stopPropagation(); setScrollbarModalOpen(true); }}>Modal w/ Scroll Bar</button>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="cookies-modal" onClick={(e) => { e.stopPropagation(); setCookiesModalOpen(true); }}>Cookies</button>
                      <ModalCookies id="cookies-modal" modalOpen={cookiesModalOpen} setModalOpen={setCookiesModalOpen} title="We use cookies 🍪">
                        ...
                        <div className="flex flex-wrap justify-end space-x-2">
                          ...
                          <button className="btn-sm bg-black hover:bg-black text-white" onClick={(e) => { e.stopPropagation(); setCookiesModalOpen(false); }}>I Accept</button>
                        </div>
                      </ModalCookies>
                      {/* End */}
                    </div>                  
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="success-modal" onClick={(e) => { e.stopPropagation(); setSuccessModalOpen(true); }}>Success Modal</button>
                        ...
                        <div className="p-5 flex space-x-4">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap justify-end space-x-2">
                              ...
                              <button className="btn-sm bg-black hover:bg-black text-white">Yes, Upgrade it</button>
                            </div>
                          </div>
                        </div>
                      </ModalBlank>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="danger-modal" onClick={(e) => { e.stopPropagation(); setDangerModalOpen(true); }}>Danger Modal</button>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="info-modal" onClick={(e) => { e.stopPropagation(); setInfoModalOpen(true); }}>Info Modal</button>
                      <ModalBlank id="info-modal" modalOpen={infoModalOpen} setModalOpen={setInfoModalOpen}>
                        <div className="p-5 flex space-x-4">
                          {/* Icon */}
                          <div className="w-10 h-10 rounded-full flex items-center justify-center shrink-0 bg-black">
                            <svg className="w-4 h-4 shrink-0 fill-current text-black" viewBox="0 0 16 16">
                          ...
                          <div>
                            ...
                            <div className="flex flex-wrap justify-end space-x-2">
                              ...
                              <button className="btn-sm bg-black hover:bg-black text-white">Yes, Create it</button>
                            </div>
                          </div>
                        </div>
                      </ModalBlank>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap items-center -m-1.5">
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="feedback-modal" onClick={(e) => { e.stopPropagation(); setFeedbackModalOpen(true); }}>Send Feedback</button>
                      <ModalBasic id="feedback-modal" modalOpen={feedbackModalOpen} setModalOpen={setFeedbackModalOpen} title="Send Feedback">
                        ...
                        <div className="px-5 py-4 border-t border-gray-200">
                          <div className="flex flex-wrap justify-end space-x-2">
                            ...
                            <button className="btn-sm bg-black hover:bg-black text-white">Send</button>
                          </div>
                        </div>
                      </ModalBasic>
                      {/* End */}
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="newsletter-modal" onClick={(e) => { e.stopPropagation(); setNewsletterModalOpen(true); }}>Newsletter</button>
                      <ModalAction id="newsletter-modal" modalOpen={newsletterModalOpen} setModalOpen={setNewsletterModalOpen}>
                        ...
                        <div className="mb-2 text-center">
                          ...
                          <div className="mb-3">
                            <svg className="inline-flex w-12 h-12 rounded-full shrink-0 fill-current" viewBox="0 0 48 48">
                              <rect className="text-black" width="48" height="48" rx="24" />
                              <path className="text-black" d="M19 16h7a8 8 0 110 16h-7V16z" />
                              <path className="text-black" d="M26 24l-7-6v5h-8v2h8v5z" />
                            </svg>
                          </div>
                        ...
                        <div className="text-center">
                          ...
                          <form className="flex max-w-sm m-auto">
                            ...
                            <button type="submit" className="btn-sm bg-black hover:bg-black text-white whitespace-nowrap">Subscribe</button>
                          </form>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="announcement-modal" onClick={(e) => { e.stopPropagation(); setAnnouncementModalOpen(true); }}>Announcement</button>
                      <ModalAction id="announcement-modal" modalOpen={announcementModalOpen} setModalOpen={setAnnouncementModalOpen}>
                        ...
                        <div className="text-center">
                          ...
                          {/* CTAs */}
                          <div className="space-y-3">
                            <button className="btn-sm bg-black hover:bg-black text-white">Claim your Reward -&gt;</button>
                            <div>
                              <a className="font-medium text-sm text-black hover:text-black" href="#0" onClick={(e) => { e.preventDefault(); setAnnouncementModalOpen(true); }}>Not Now!</a>
                            </div>
                          </div>
                        </div>
                      </ModalAction>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="integration-modal" onClick={(e) => { e.stopPropagation(); setIntegrationModalOpen(true); }}>Integration</button>
                      <ModalAction id="integration-modal" modalOpen={integrationModalOpen} setModalOpen={setIntegrationModalOpen}>
                        ...
                        <div className="text-sm mb-5">
                          ...
                          <div className="text-xs text-gray-500">By clicking on Allow access, you authorize Mosaic to use your information in accordance with its <a className="text-black hover:text-black" href="#0">Privacy Policy</a>. You can stop it at any time on the integrations page of your Mosaic account.</div>
                        </div>
                        {/* Modal footer */}
                        <div className="flex flex-wrap justify-end space-x-2">
                          ...
                          <button className="btn-sm bg-black hover:bg-black text-white">Allow Access</button>
                        </div>
                      </ModalAction>
                      {/* End */}
                    </div>
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="news-modal" onClick={(e) => { e.stopPropagation(); setNewsModalOpen(true); }}>What's New</button>
                      <ModalBlank id="news-modal" modalOpen={newsModalOpen} setModalOpen={setNewsModalOpen}>
                        ...
                        <div className="p-5">
                          ...
                          <div className="mb-2">
                            <div className="mb-3">
                              <div className="text-xs inline-flex font-medium bg-black text-black rounded-full text-center px-2.5 py-1">New on Mosaic</div>
                            </div>
                          ...
                          {/* Modal footer */}
                          <div className="flex flex-wrap justify-end space-x-2">
                            <button className="btn-sm bg-black hover:bg-black text-white" onClick={(e) => { e.stopPropagation(); setNewsModalOpen(false); }}>Cool, I Got it</button>
                          </div>
                        </div>                      
                      </ModalBlank>
                      {/* End */}
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="feedback-modal" onClick={(e) => { e.stopPropagation(); setPlanModalOpen(true); }}>Change your Plan</button>
                      <ModalBasic id="feedback-modal" modalOpen={planModalOpen} setModalOpen={setPlanModalOpen} title="Change your Plan">
                        ...
                        <div className="px-5 pt-4 pb-1">
                          <div className="text-sm">
                            ...
                            <ul className="space-y-2 mb-4">
                              <li>
                                <button className="w-full h-full text-left py-3 px-4 rounded bg-white border-2 border-black shadow-sm duration-150 ease-in-out">
                                  <div className="flex items-center">
                                    <div className="w-4 h-4 border-4 border-black rounded-full mr-3"></div>
                                    <div className="grow">
                              ...
                              <li>
                                <button className="w-full h-full text-left py-3 px-4 rounded bg-white border border-gray-200 hover:border-gray-300 shadow-sm duration-150 ease-in-out">
                                  <div className="flex items-center">
                                    ...
                                    <div className="grow">
                                      <div className="flex flex-wrap items-center justify-between mb-0.5">
                                        <span className="font-semibold text-gray-800">Mosaic Basic <span className="text-xs italic text-black align-top">Best Value ✨</span></span>
                        ...
                        <div className="px-5 py-4">
                          <div className="flex flex-wrap justify-end space-x-2">
                            ...
                            <button className="btn-sm bg-black hover:bg-black text-white">Change Plan</button>
                          </div>
                        </div>
                      </ModalBasic>
                      {/* End */}
                    ...
                    <div className="m-1.5">
                      {/* Start */}
                      <button className="btn bg-black hover:bg-black text-white" aria-controls="quick-find-modal" onClick={(e) => { e.stopPropagation(); setSearchModalOpen(true); }}>Quick Find</button>
