              ...
              <div className="space-y-8 mt-8">
                ...
                <div>
                  <div className="flex items-start space-x-3 mb-6">
                    ...
                    <div className="text-xs inline-flex font-medium bg-black text-black rounded-full text-center px-2.5 py-1">Recommended</div>
                  </div>
                  <div className="px-6 py-8 bg-gray-800 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                    ...
                    <div className="inline-flex space-x-3">
                      <a className="btn bg-black hover:bg-black text-white" href="https://nucleoapp.com/pricing" target="_blank" rel="noreferrer">Buy Nucleo</a>
                ...
                <div>
                  ...
                  <div className="px-6 py-8 bg-gray-800 rounded-sm text-center xl:text-left xl:flex xl:flex-wrap xl:justify-between xl:items-center">
                    ...
                    <div className="inline-flex space-x-3">
                      <a className="btn bg-black hover:bg-black text-white" href="https://tablericons.com/" target="_blank" rel="noreferrer">Download Tabler Icons</a>
                    </div>
                  </div>
                </div>
